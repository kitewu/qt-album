#############################################################################
# Makefile for building: myalbum
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri May 19 18:18:48 2017
# Project:  myalbum.pro
# Template: app
# Command: /opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/qmake -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile myalbum.pro
#############################################################################
...
Makefile: myalbum.pro  /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++/qmake.conf /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/linux.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base-unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile myalbum.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/myalbum1.0.0 || $(MKDIR) .tmp/myalbum1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/myalbum1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/myalbum1.0.0/ && $(COPY_FILE) --parents gif.qrc .tmp/myalbum1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/myalbum1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/myalbum1.0.0/ && (cd `dirname .tmp/myalbum1.0.0` && $(TAR) myalbum1.0.0.tar myalbum1.0.0 && $(COMPRESS) myalbum1.0.0.tar) && $(MOVE) `dirname .tmp/myalbum1.0.0`/myalbum1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/myalbum1.0.0
...
compiler_rcc_make_all: qrc_gif.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_gif.cpp
qrc_gif.cpp: gif.qrc \
		gif/animated.gif
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/rcc -name gif gif.qrc -o qrc_gif.cpp
...
qrc_gif.o: qrc_gif.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_gif.o qrc_gif.cpp
